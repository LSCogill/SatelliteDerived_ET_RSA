...
lines(BF1$TC_monthly, lwd = 2, col = "blue")
lines(BF1$SMAP_monthly, lwd = 2, col = "orange")
lines(BF1$WaPOR_monthly, lwd = 2, col = "limegreen")
lines(BF1$GLDAS_monthly, lwd = 2, col = "red")
lines(BF1$MOD16_monthly, lwd = 2, col = "saddlebrown")
lines(BF1$PTjpl_monthly, lwd = 2, col = "yellow")
lines(BF1$SSEBop_monthly, lwd = 2, col = "magenta")
lines(BF1$FLDAS_monthly, lwd = 2, col = "purple")
